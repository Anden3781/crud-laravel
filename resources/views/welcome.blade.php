...
<head>
    ...
    <script src="https://kit.fontawesome.com/f90823062e.js" crossorigin="anonymous"></script>
</head>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Registro de productos
                </h1>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" data-bs-toggle="modal" data-bs-target="#modalEditar{{ $item->id_producto }}"
                                class="btn btn-warning btn-sm"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>
